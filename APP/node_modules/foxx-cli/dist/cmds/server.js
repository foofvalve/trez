...
exports.builder = yargs => common(yargs, { command, aliases, describe }).command(require("./server/list")).command(require("./server/remove")).command(require("./server/set")).command(require("./server/show"));